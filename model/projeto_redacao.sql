...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/06/2023 às 21:39
...
CREATE TABLE `administrador` (
  ...
  `nome_completo` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
--
-- Despejando dados para a tabela `biografia`
--
...
(5, 'Example', 'slslslsls', 'IMG_20160816_114113589.jpg'),
(6, 'ex2', 'lisinho', 'IMG_20160816_160334.jpg');
...
CREATE TABLE `redacoes` (
  ...
  `tema` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `autor` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `nota` varchar(11) DEFAULT NULL,
  `redacao` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `comentarios` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
...
CREATE TABLE `repertorio` (
  ...
  `citacao` mediumtext NOT NULL,
  `id_tipo_repertorio` int(11) NOT NULL,
  `id_tematica` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Despejando dados para a tabela `repertorio`
--
...
--
-- Estrutura para tabela `tematica`
--
...
--
-- Despejando dados para a tabela `tematica`
--
...
--
-- Estrutura para tabela `tipo_repertorio`
--
...
--
-- Despejando dados para a tabela `tipo_repertorio`
--
...
--
-- Índices de tabela `tematica`
--
ALTER TABLE `tematica`
  ADD PRIMARY KEY (`id_tematica`);

--
-- Índices de tabela `tipo_repertorio`
--
...
--
-- AUTO_INCREMENT de tabela `tematica`
--
ALTER TABLE `tematica`
  MODIFY `id_tematica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `tipo_repertorio`
--
ALTER TABLE `tipo_repertorio`
